...
const clothingItems = [
  {
    ...
    category: 'TOP',
    description: 'Soft organic cotton tee with a relaxed fit and crew neckline.',
    price: 32.0,
    primaryColor: 'blue',
    colors: ['blue', 'white'],
    sizes: ['S', 'M', 'L'],
  ...
  },
  {
    name: 'Coastal Chinos',
    category: 'BOTTOM',
    description: 'Lightweight stretch chinos with tapered leg and clean finish.',
    price: 68.0,
    primaryColor: 'khaki',
    colors: ['khaki', 'navy'],
    sizes: ['M', 'L', 'XL'],
  ...
  },
  {
    ...
    category: 'ACCESSORY',
    description: 'Durable canvas tote with interior laptop sleeve and zip pocket.',
    price: 48.0,
    primaryColor: 'black',
    colors: ['black', 'olive'],
    sizes: [],
